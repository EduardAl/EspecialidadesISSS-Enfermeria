...
<div class = "container">
	<div class = "row">
		<div class="col-xs-12">
			<h1>Procedimientos de Cirugía Periférica</h1>
		...
		<div id="filtro" class="col-xs-12" align="right">
			<form method="post" action="<?php echo  RUTA_URL . '/Nivel/Especialidad/7/Periferica'?>">
				<div class="col-xs-1">
		...
		<div>
			<div class="col-xs-12" style="overflow: auto; max-height: 400px;">
					<?php $data=$datos; $id=1;$datos=$data['datos2']; $id++;
