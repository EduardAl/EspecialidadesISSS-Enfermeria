...
<body>
	...
	<div class = "container" style="min-height: 500px;">
		...
		<div class = "row">
			<div  class="col-xs-12">
				<h1 class="">Sexto Nivel</h1>
			</div>
			<!-- Procedimientos Mes -->
			<div class="col-xs-12" id="datosNivel">
  				<form class="form-formulario" method="POST" action="<?= RUTA_URL . '/Mantenimiento/IngresoNivel/6' ?>">
			...
			<?php
					...
					?>
  					<form class="form-formulario" method="POST" action="<?php echo  RUTA_URL . '/Mantenimiento/IngresoEspecialidad/6/'.$key->id?>">
					<div class="col-xs-12" style="display: inline-block; align-items: center">
    					<button class="btn btn-primary navbar-right" type="submit">Ingresar Datos</button>
					</div>
					<?php 
			...
			if(isset($data['especialidades']))
			{
					...
					?>
  					...
  					<form class="form-formulario" method="POST" action="<?php echo  RUTA_URL . '/Mantenimiento/IngresoProcedimiento/6/'.$key->id?>">
					<div class="col-xs-12" style="display: inline-block; align-items: center">
    					<button class="btn btn-primary navbar-right" type="submit">Ingresar Datos</button>
					</div >
					<?php 
