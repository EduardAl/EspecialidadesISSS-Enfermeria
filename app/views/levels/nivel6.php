...
<div>
	<div class="col-xs-12" style="background: #050D42;">
		<div class="container">
			...
			<div class="col-xs-2" >
				<br>
	  			<button class="btn btn-primary btn-block" onclick="window.location='<?php echo RUTA_URL?>/Mantenimiento/Nivel/6'">Ingresar Datos</button>
			</div>
		</div>
	</div>
...
<div class = "container">
	<div class = "row">
		<div <div id="especialidades" style="min-height: 350px;">
			<div class="col-xs-12">
